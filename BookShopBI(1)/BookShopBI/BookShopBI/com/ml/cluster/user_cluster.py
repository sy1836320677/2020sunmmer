...
def cluster_output():
    ...
    # 执行聚类
    #shell = HADOOP_PATH + "hadoop jar " + PROJECT_LIB_DIR + "usercluster1.jar com.clustering.KMeansMahout" + " /user/hive/warehouse/cluster_input "+ clusterOutputPath + t1 + " " + t2 + " " + convergenceDelta + " " + maxIterations
    #shell = HADOOP_PATH + "hadoop jar " + PROJECT_LIB_DIR + "usercluster.jar com.clustering.KMeansMahout" + " /user/hive/warehouse/cluster_input "+ clusterOutputPath
    shell = HADOOP_PATH + "hadoop jar " + PROJECT_LIB_DIR + "usercluster.jar com.clustering.KMeansMahout" + " /user/hive/warehouse/cluster_input "+ clusterOutputPath+" "+t1+" "+t2
    os.system(shell)
    ...
    #hql = "load data local inpath '" + PROJECT_TMP_DIR + "result overwrite into table summer.cluster_result"
