...
public class BaseUserutil {
    public List<RecommendedItem> userrecommend(int userID){
        // 准备数据 这里是电影评分数据
...
//		 System.out.println(file);
        ...
        try {
            String file = "C:\\Users\\Asus\\Desktop\\bx_ratings.csv";
            ...
            int howmany = 10;
            // 给用户ID等于5的用户推荐10部电影
            recommendedItemList = recommender.recommend(userid, howmany);
            // 打印推荐的结果
