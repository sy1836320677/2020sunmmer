...
public class Driver {
    ...
    public static void main(String[] args) {
        try {
            ...
            String HDFS = "hdfs://ecs-hadoop-master:9000/";
...
//				System.exit(2);
//			}
            String inputPath = HDFS + "weblog/apachelogs/in/localhost_access_log.2019-06-13.txt";
            String outputPath = HDFS + "user/hive/warehouse/summer.db/clickstream_log/dt=2019-06-13";
