<template>
  <el-container style="height: 500px; border: 1px solid #eee">
    <el-container>
      <el-header style="text-align: center; font-size: 24px">我的上架</el-header>
        <el-container>
...
export default {
  ...
  data () {
    return {
      accounts: [],
      url: 'https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=38935391,819832118&fm=26&gp=0.jpg',
  ...
  mounted () {
    axios.post('http://' + this.$ip + ':' + this.$port + '/mysj').then(res => {
      console.log('上架列表')
      console.log(res)
