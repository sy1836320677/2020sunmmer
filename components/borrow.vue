<template>
  <el-container style="height: 500px; border: 1px solid #eee">
    <el-container>
      <el-header style="text-align: center; font-size: 24px">基于用户推荐图书</el-header>
        <el-container>
                  ...
                  <div class="demo-image">
                    ...
                    <el-container direction="vertical">
                      <el-image
                        ...
                        :fits="fit"
                        @click="accountInfo(account.account,account.name,account.outline,account.detail,account.press,account.author,account.translator,account.price,account.imageUrl)"
                      ></el-image>
                      <el-container direction="vertical">
                        <el-container>
...
export default {
  ...
  mounted () {
    axios.post('http://' + this.$ip + ':' + this.$port + '/baseuser').then(res => {
      console.log('基于用户推荐列表')
      console.log(res)
