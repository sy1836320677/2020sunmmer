<template>
  <el-container style="height: 500px; border: 1px solid #eee">
    <el-container>
      <el-header style="text-align: center; font-size: 24px">好友推荐</el-header>
        <el-container>
                  ...
                  <div class="demo-image">
                    ...
                    <el-container direction="vertical">
                      ...
                      <el-container direction="vertical">
                        ...
                        <el-container>
                          <el-tag>{{account.nickname}}</el-tag>
                          <el-tag type="success">{{account.email}}</el-tag>
                          <el-tag type="info">{{account.gender}}</el-tag>
                        </el-container>
                      </el-container>
                    </el-container>
                  </div>
...
export default {
  ...
  mounted () {
    axios.post('http://' + this.$ip + ':' + this.$port + '/userCluster/selectOne').then(res => {
      console.log('商品列表')
      console.log(res)
