<template>
  <el-container style="height: 500px; border: 1px solid #eee">
    <el-container>
      ...
      <el-header style="text-align: center; font-size: 24px">基于图书推荐列表</el-header>
        <el-container>
...
export default {
  ...
  mounted () {
    ...
    params.append('bookid', this.$route.query.bookId)
    axios.post('http://' + this.$ip + ':' + this.$port + '/test1', params).then(res => {
      console.log('基于图书推荐')
      console.log(res)
